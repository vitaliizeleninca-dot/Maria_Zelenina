        ...
        <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-lg rounded-[3rem] p-10 md:p-16 shadow-2xl border border-white/20">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <form className="space-y-6">
              ...
              <button className="w-full py-4 bg-pink hover:bg-pink-600 text-white font-bold rounded-2xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                Send
              </button>
            </form>
          </div>
